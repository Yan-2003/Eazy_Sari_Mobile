  ...
  return (
    <View style={styles.main}>
        <View style={styles.container}>
            <TouchableOpacity style={styles.nav_btn} onPress={()=> router.push({pathname : '/' , params : {userdata : data}})}>
            ...
            <TouchableOpacity style={styles.nav_btn} onPress={()=> router.push({pathname : '/product' , params : {userdata : data}})}>
            ...
            <TouchableOpacity style={styles.nav_btn_big} onPress={()=>router.push({pathname : 'new_transaction', params : {userdata : data}})}>
