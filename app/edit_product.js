...
export default function edit_prouct() {

    const {userdata, product_data} = useLocalSearchParams()
    ...
    const [productDetails, setproductDetails] = useState(product.discription);
    ...
    <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
        <View style={styles.contianer}>
            ...
            <View style={styles.header}>
                    ...
                    <Text style={styles.header_text}>Edit your <Text style={styles.text_green} >Product</Text></Text>
                </View>
                ...
                <View style={styles.body} >
                    <View style={styles.pic_container}>
                        ...
                        {
                            image == null ? <Image source={images[oldImage]} style={styles.cameraImage} /> : <></>
                        }
